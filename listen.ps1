...
$choices.Add(@("hello", "name", "who are you", "how are you", "shut down", "power off", "hey robot", "open calculator", "open notepad", "open paint", "open browser", "open chrome", "open edge", "open control panel", "open cmd"))
